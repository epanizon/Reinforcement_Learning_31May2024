...
class Agent: 
    ...
    def __init__(self,env, critic_lr=0.001,actor_lr=0.001, tau=0.005, gamma = 0.99, update_actor_interval = 2, warmup = 1000,max_size = 1000000, layer1_size= 400, layer2_size= 300, batch_size = 100, noise = 0.2,chkpt_dir = "model"):
